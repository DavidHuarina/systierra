...
function displayBlockServ(vd,vi){
  $('#'+vd).attr('checked', 'checked');
  $('#'+vi).removeAttr('checked');
  if(vi=='optradio1'){
     /*$('#div-impuesto').addClass('validate-input');
     $("#div-impuesto").attr("data-validate","Campo requerido");*/
     $('#lista-com').css("display", "none");
     $('#otro-com').css("display", "block");
     
  }else{
   /* $('#div-impuesto').removeClass('validate-input');
     $("#div-impuesto").removeAttr("data-validate");*/
    $('#lista-com').css("display", "block");
     $('#otro-com').css("display", "none");     
...
function validarMontoSupImpuesto(e){
  var cadena=$('#monto').val();
