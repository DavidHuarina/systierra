L.Control.SlideMenu = L.Control.extend({
    ...
    onAdd: function(map){
        ...
        var link = L.DomUtil.create('a', 'leaflet-bar-part leaflet-bar-part-single menu', this._container);
        link.title = 'Menu';
        ...
        if(this._isHorizontal){
            if(this._isLeftPosition){
                ...
                L.DomUtil.addClass(closeButton, 'fa-chevron-left btn-close-1');
            }
            else{
                closeButton.style.float = 'left';
                L.DomUtil.addClass(closeButton, 'fa-chevron-right btn-close-2');
            }
        }
        else{
            if(this._isTopPosition){
