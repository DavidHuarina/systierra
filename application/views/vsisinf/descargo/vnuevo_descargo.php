                ...
                <form id="form_cb" autocomplete="off" action="cnuevo_descargo/agregar?ac=<?=$actividad->act_id?>&id=<?=$proy->id_proyecto?>&df=<?=$df?>" class="validate-form" method="post">
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label class="cb-radio" onclick="displayBlockServ('optradio1','optradio2','optradio3')"><input type="radio" value="1" name="optradio" id="optradio1" checked="checked">Servicios</label>
                    
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label class="cb-radio" onclick="displayBlockServ('optradio2','optradio1','optradio3')"><input type="radio" value="2" name="optradio" id="optradio2">Bienes</label>
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label class="cb-radio" onclick="displayBlockServ('optradio3','optradio1','optradio2')"><input type="radio" value="3" name="optradio" id="optradio3">Vi&aacute;ticos</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-6 pr-1">
                          <div class="form-group">
                             <label>Impuesto %</label>
                               <input type="text" onkeypress="return validarMontoSupImpuesto(event,this.id);" id="impuesto_ser" name="impuesto_ser" class="form-control"  value="15">
                          </div>
                        </div>
                        <div class="col-md-6 pl-1">
                          <div class="form-group">
                             <label>Monto ajustado</label>
                               <input type="text" onkeypress="return validarMontoSupImpuesto(event,this.id);" id="monto_serv" name="monto_serv" class="form-control"  value="0" readonly="readonly">
                          </div>
                        </div>
                      </div>      
                     </div>
                     <div id="lista-com-via" style="display:none">
                      <div id="div-impuesto" class="form-group">
                             <label>RECIBO</label>
                               <input type="text" onkeypress="return validarNumero(event)" id="via_reci" name="via_reci" class="form-control"  value="0">
                              </div>
                      <div class="row">
                        <div class="col-md-6 pr-1">
                          <div class="form-group">
                             <label>Impuesto %</label>
                               <input type="text" onkeypress="return validarMontoSupImpuesto(event,this.id);" id="via_impuesto" name="via_impuesto" class="form-control"  value="13">
                          </div>
                        </div>
                        <div class="col-md-6 pl-1">
                          <div class="form-group">
                             <label>Monto ajustado</label>
                               <input type="text" onkeypress="return validarMontoSupImpuesto(event,this.id);" id="via_monto" name="via_monto" class="form-control"  value="0" readonly="readonly">
                          </div>
                        </div>
                      </div>      
                     </div>
                            ...
                            <div id="otro-com_d" style="display:none">
                              <div class="row">
                                <div class="col-md-4 pr-1">
                                  <div class="form-group">
                                     <label>Impuesto %</label>
                                     <input type="text" onkeypress="return validarMontoSupImpuesto(event,this.id);" id="impuesto" name="impuesto" class="form-control"  value="8">
                                  </div>
                                </div>
                                <div class="col-md-8 pl-1">
                                  <div class="form-group">
                                     <label>Monto ajustado</label>
                                     <input type="text" onkeypress="return validarMontoSupImpuesto(event,this.id);" id="monto_bien" name="monto_bien" class="form-control"  value="0" readonly="readonly">
                                  </div>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="col-md-6 pl-1">
                      ...
                      <div class="form-group validate-input" data-validate="Campo requerido">
                        ...
                        <input type="text" onkeypress="return validarMontoSupImpuesto(event,this.id);" id="monto" name="monto" class="form-control" placeholder="" value="">
                      </div>
                    </div>
                    </div>                        
                         ...
                         if($detg->impuesto_serv>0){
                          ...
                          <?php
                           ...
                           if($detg->impuesto_bien>0){
                            if($detg->impuesto_bien==13){
                              ?>
                             <td>
                              Rec. <?=$detg->n_fac_reci?>
                             </td>
                             <td>
                             Via. <?=$detg->impuesto_bien?> %
                             </td>
                             <?php
                            }else{
                              ?>
