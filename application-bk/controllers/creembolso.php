...
class Creembolso extends C_datos {
	...
	{ 
		...
		$datosUsuario['title_nav']="Reembolsos";
		$this->load->view('vsisinf/vplantilla/vbarralateral',$datosUsuario);
		$this->load->view('vsisinf/vplantilla/vnavegacion');		
		$this->load->view('vsisinf/reembolso/vreembolsos');
		//$this->load->view('vsisinf/vplantilla/modals/vact_modal');
		$this->load->view('vsisinf/vplantilla/vfooter');
	}
	function completarDatos(){
		$datos['descargo']=$this->descargo->getAllRem($this->session->userdata('id_usuario_sesion'));
		$datos['ndes']=$this->descargo->getNDRem($this->session->userdata('id_usuario_sesion'));
		return $datos;
	}
	function aprobar(){
		$id_sol=$_REQUEST['q'];
