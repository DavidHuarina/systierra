   ...
   <div class="panel-header">
        <div class="header text-center">
          <h2 class="title">Reembolsos</h2>
          <p class="category"><a href="#">lista de descargos con reembolsos</a> 
          </p>
        </div>
    </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title mb-4">Reembolsos recibidos <small class="text-info"><?=$ndes->num?></small></h4>
                </div>
                <div class="card-body">                  
                  <div class="fluid-container">
                    ...
                    foreach ($descargo->result() as $descar) {
                      ...
                      <div class="col-md-1 d-md-flex d-none">
                        <img class="img-sm mb-4 mb-md-0" src="apps/full-icon/flat/negocio/piggy-bank-1.png" alt="profile image">
                      </div>
